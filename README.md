# BF_REP v0.0.1 - Bifrost Replication Module

BF_REP provides the replication framework for Bifrost Engine, it is intended to be used in conjunction with BF_ECS and BF_ENET which is the backend for the netcode (may be a module, or more likely an extension to this module).
